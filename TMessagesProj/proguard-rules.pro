...
-keep class org.papercraft.messenger.* { *; }
-keep class org.papercraft.messenger.camera.* { *; }
-keep class org.papercraft.messenger.secretmedia.* { *; }
-keep class org.papercraft.messenger.support.* { *; }
-keep class org.papercraft.messenger.support.* { *; }
-keep class org.papercraft.messenger.time.* { *; }
-keep class org.papercraft.messenger.video.* { *; }
-keep class org.papercraft.messenger.voip.* { *; }
-keep class org.papercraft.SQLite.** { *; }
-keep class org.papercraft.tgnet.ConnectionsManager { *; }
-keep class org.papercraft.tgnet.NativeByteBuffer { *; }
-keep class org.papercraft.tgnet.RequestDelegateInternal { *; }
-keep class org.papercraft.tgnet.RequestTimeDelegate { *; }
-keep class org.papercraft.tgnet.RequestDelegate { *; }
-keep class org.papercraft.tgnet.QuickAckDelegate { *; }
-keep class org.papercraft.tgnet.WriteToSocketDelegate { *; }
