    ...
    public void setStorageUsage(boolean calculating, long database, long totalSize, long totalDeviceFreeSize, long totalDeviceSize) {
        ...
        if (calculating) {
            ...
            if (totalSize > 0) {
                ...
                textSettingsCell.setTextAndValue(LocaleController.getString("ClearPapercraftCache", R.string.ClearPapercraftCache), AndroidUtilities.formatFileSize(totalSize), true);
                telegramCacheTextView.setText(LocaleController.formatString("PapercraftCacheSize", R.string.PapercraftCacheSize, AndroidUtilities.formatFileSize(totalSize + database)));
            } else {
                telegramCacheTextView.setVisibility(View.GONE);
