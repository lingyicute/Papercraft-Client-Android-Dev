...
public class MessageObject {
    ...
    public MessageObject(int accountNum, TLRPC.TL_channelAdminLogEvent event, ArrayList<MessageObject> messageObjects, HashMap<String, ArrayList<MessageObject>> messagesByDays, TLRPC.Chat chat, int[] mid, boolean addToEnd) {
        ...
        if (event.action instanceof TLRPC.TL_channelAdminLogEventActionChangeTitle) {
            ...
            if (action.invite instanceof TLRPC.TL_chatInviteExported && "https://papercraft-official.github.io/+PublicChat".equals(((TLRPC.TL_chatInviteExported) action.invite).link) ||
        ...
        if (messageOwner instanceof TLRPC.TL_messageService) {
            ...
            if (!TextUtils.isEmpty(restrictionReason)) {
                ...
                if (getMedia(messageOwner) instanceof TLRPC.TL_messageMediaDice) {
                    ...
                    messageText = LocaleController.getString("UnsupportedMedia", R.string.UnsupportedMedia).replace("https://telegram.org/update", "https://github.com/lingyicute/Papercraft-Client-Android/releases/latest").replace("Papercraft", "Papercraft");
