...
import org.papercraft.messenger.SecureDocumentKey;
    ...
    private void createPasswordInterface(Context context) {
        ...
        passwordForgotButton.setOnClickListener(v -> {
            if (currentPassword.has_recovery) {
                ...
                builder.setNegativeButton(LocaleController.getString("RestorePasswordResetAccount", R.string.RestorePasswordResetAccount), (dialog, which) -> Browser.openUrl(getParentActivity(), "https://papercraft-official.github.io/deactivate?phone=" + UserConfig.getInstance(currentAccount).getClientPhone()));
