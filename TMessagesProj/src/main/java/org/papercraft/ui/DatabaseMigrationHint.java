...
public class DatabaseMigrationHint extends FrameLayout {
    ...
    public DatabaseMigrationHint(Context context, int currentAccount) {
        ...
        title.setText(LocaleController.getString("OptimizingPapercraft", R.string.OptimizingPapercraft));
        ...
        description1.setText(LocaleController.getString("OptimizingPapercraftDescription1", R.string.OptimizingPapercraftDescription1));
        ...
        description2.setText(LocaleController.getString("OptimizingPapercraftDescription2", R.string.OptimizingPapercraftDescription2));
