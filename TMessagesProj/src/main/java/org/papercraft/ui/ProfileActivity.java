...
import static org.papercraft.messenger.ContactsController.PRIVACY_RULES_TYPE_ADDED_BY_PHONE;
...
import org.papercraft.messenger.ChatThemeController;
...
import org.papercraft.messenger.LanguageDetector;
...
import org.papercraft.ui.Cells.AboutLinkCell;
...
import org.papercraft.ui.Cells.SettingsSearchCell;
import org.papercraft.ui.Cells.SettingsSuggestionCell;
...
import org.papercraft.ui.Cells.TextDetailCell;
import org.papercraft.ui.Cells.TextInfoPrivacyCell;
import org.papercraft.ui.Cells.UserCell;
...
import org.papercraft.ui.Components.AutoDeletePopupWrapper;
...
import org.papercraft.ui.Components.CanvasButton;
import org.papercraft.ui.Components.ChatActivityInterface;
import org.papercraft.ui.Components.ChatAvatarContainer;
import org.papercraft.ui.Components.ChatNotificationsPopupWrapper;
import org.papercraft.ui.Components.ColoredImageSpan;
import org.papercraft.ui.Components.CombinedDrawable;
import org.papercraft.ui.Components.CrossfadeDrawable;
...
import org.papercraft.ui.Components.HintView;
import org.papercraft.ui.Components.IdenticonDrawable;
...
import org.papercraft.ui.Components.Premium.GiftPremiumBottomSheet;
import org.papercraft.ui.Components.Premium.PremiumFeatureBottomSheet;
import org.papercraft.ui.Components.Premium.PremiumGradient;
import org.papercraft.ui.Components.Premium.PremiumPreviewBottomSheet;
import org.papercraft.ui.Components.Premium.ProfilePremiumCell;
        ...
        if (position == usernameRow || position == setUsernameRow) {
            ...
            if (position == phoneRow) {
                if (userInfo != null && userInfo.phone_calls_available) {
                    ...
                    items.add(LocaleController.getString("CallViaPapercraft", R.string.CallViaPapercraft));
                    actions.add(PHONE_OPTION_TELEGRAM_CALL);
                    if (userInfo.video_calls_available) {
                        icons.add(R.drawable.msg_videocall);
                        items.add(LocaleController.getString("VideoCallViaPapercraft", R.string.VideoCallViaPapercraft));
            ...
            switch (holder.getItemViewType()) {
                ...
                case VIEW_TYPE_TEXT:
                    ...
                    if (position == settingsTimerRow) {
                        ...
                        textCell.setTextAndIcon(LocaleController.getString("PapercraftPremium", R.string.PapercraftPremium), new AnimatedEmojiDrawable.WrapSizeDrawable(PremiumGradient.getInstance().premiumStarMenuDrawable, AndroidUtilities.dp(24), AndroidUtilities.dp(24)), false);
                        textCell.setImageLeft(23);
                    }
                    break;
                case VIEW_TYPE_NOTIFICATIONS_CHECK:
    ...
    private class SearchAdapter extends RecyclerListView.SelectionAdapter {
        ...
        private SearchResult[] onCreateSearchArray() {
            return new SearchResult[]{
                ...
                isPremiumFeatureAvailable(-1) ? new SearchResult(800, LocaleController.getString(R.string.PapercraftPremium), R.drawable.msg_settings_premium, () -> presentFragment(new PremiumPreviewFragment("settings"))) : null,
                isPremiumFeatureAvailable(PremiumPreviewFragment.PREMIUM_FEATURE_LIMITS) ? new SearchResult(801, LocaleController.getString(R.string.PremiumPreviewLimits), LocaleController.getString(R.string.PapercraftPremium), R.drawable.msg_settings_premium, () -> showDialog(new PremiumFeatureBottomSheet(ProfileActivity.this, PremiumPreviewFragment.PREMIUM_FEATURE_LIMITS, false).setForceAbout())) : null,
                isPremiumFeatureAvailable(PremiumPreviewFragment.PREMIUM_FEATURE_ANIMATED_EMOJI) ? new SearchResult(802, LocaleController.getString(R.string.PremiumPreviewEmoji), LocaleController.getString(R.string.PapercraftPremium), R.drawable.msg_settings_premium, () -> showDialog(new PremiumFeatureBottomSheet(ProfileActivity.this, PremiumPreviewFragment.PREMIUM_FEATURE_ANIMATED_EMOJI, false).setForceAbout())) : null,
                isPremiumFeatureAvailable(PremiumPreviewFragment.PREMIUM_FEATURE_UPLOAD_LIMIT) ? new SearchResult(803, LocaleController.getString(R.string.PremiumPreviewUploads), LocaleController.getString(R.string.PapercraftPremium), R.drawable.msg_settings_premium, () -> showDialog(new PremiumFeatureBottomSheet(ProfileActivity.this, PremiumPreviewFragment.PREMIUM_FEATURE_UPLOAD_LIMIT, false).setForceAbout())) : null,
                isPremiumFeatureAvailable(PremiumPreviewFragment.PREMIUM_FEATURE_DOWNLOAD_SPEED) ? new SearchResult(804, LocaleController.getString(R.string.PremiumPreviewDownloadSpeed), LocaleController.getString(R.string.PapercraftPremium), R.drawable.msg_settings_premium, () -> showDialog(new PremiumFeatureBottomSheet(ProfileActivity.this, PremiumPreviewFragment.PREMIUM_FEATURE_DOWNLOAD_SPEED, false).setForceAbout())) : null,
                isPremiumFeatureAvailable(PremiumPreviewFragment.PREMIUM_FEATURE_VOICE_TO_TEXT) ? new SearchResult(805, LocaleController.getString(R.string.PremiumPreviewVoiceToText), LocaleController.getString(R.string.PapercraftPremium), R.drawable.msg_settings_premium, () -> showDialog(new PremiumFeatureBottomSheet(ProfileActivity.this, PremiumPreviewFragment.PREMIUM_FEATURE_VOICE_TO_TEXT, false).setForceAbout())) : null,
                isPremiumFeatureAvailable(PremiumPreviewFragment.PREMIUM_FEATURE_ADS) ? new SearchResult(806, LocaleController.getString(R.string.PremiumPreviewNoAds), LocaleController.getString(R.string.PapercraftPremium), R.drawable.msg_settings_premium, () -> showDialog(new PremiumFeatureBottomSheet(ProfileActivity.this, PremiumPreviewFragment.PREMIUM_FEATURE_ADS, false).setForceAbout())) : null,
                isPremiumFeatureAvailable(PremiumPreviewFragment.PREMIUM_FEATURE_REACTIONS) ? new SearchResult(807, LocaleController.getString(R.string.PremiumPreviewReactions), LocaleController.getString(R.string.PapercraftPremium), R.drawable.msg_settings_premium, () -> showDialog(new PremiumFeatureBottomSheet(ProfileActivity.this, PremiumPreviewFragment.PREMIUM_FEATURE_REACTIONS, false).setForceAbout())) : null,
                isPremiumFeatureAvailable(PremiumPreviewFragment.PREMIUM_FEATURE_STICKERS) ? new SearchResult(808, LocaleController.getString(R.string.PremiumPreviewStickers), LocaleController.getString(R.string.PapercraftPremium), R.drawable.msg_settings_premium, () -> showDialog(new PremiumFeatureBottomSheet(ProfileActivity.this, PremiumPreviewFragment.PREMIUM_FEATURE_STICKERS, false).setForceAbout())) : null,
                ...
                isPremiumFeatureAvailable(PremiumPreviewFragment.PREMIUM_FEATURE_EMOJI_STATUS) ? new SearchResult(813, LocaleController.getString(R.string.PremiumPreviewEmojiStatus), LocaleController.getString(R.string.PapercraftPremium), R.drawable.msg_settings_premium, () -> showDialog(new PremiumFeatureBottomSheet(ProfileActivity.this, PremiumPreviewFragment.PREMIUM_FEATURE_EMOJI_STATUS, false).setForceAbout())) : null,
                ...
                new SearchResult(403, LocaleController.getString("PapercraftFAQ", R.string.PapercraftFAQ), LocaleController.getString("SettingsHelp", R.string.SettingsHelp), R.drawable.msg2_help, () -> Browser.openUrl(getParentActivity(), LocaleController.getString("PapercraftFaqUrl", R.string.PapercraftFaqUrl))),
        ...
        private void loadFaqWebPage() {
            ...
            req2.url = LocaleController.getString("PapercraftFaqUrl", R.string.PapercraftFaqUrl);
            req2.hash = 0;
