...
import org.papercraft.messenger.FilesMigrationService;
...
import org.papercraft.messenger.XiaomiUtilities;
...
import org.papercraft.ui.ActionBar.MenuDrawable;
import org.papercraft.ui.ActionBar.SimpleTextView;
import org.papercraft.ui.ActionBar.Theme;
import org.papercraft.ui.ActionBar.ThemeDescription;
import org.papercraft.ui.Adapters.DialogsAdapter;
import org.papercraft.ui.Adapters.DialogsSearchAdapter;
import org.papercraft.ui.Adapters.FiltersView;
import org.papercraft.ui.Cells.AccountSelectCell;
import org.papercraft.ui.Cells.ArchiveHintInnerCell;
import org.papercraft.ui.Cells.DialogCell;
import org.papercraft.ui.Cells.DialogsEmptyCell;
import org.papercraft.ui.Cells.DialogsHintCell;
...
import org.papercraft.ui.Cells.RequestPeerRequirementsCell;
...
import org.papercraft.ui.Components.DialogsItemAnimator;
import org.papercraft.ui.Components.EditTextBoldCursor;
import org.papercraft.ui.Components.FilterTabsView;
import org.papercraft.ui.Components.FiltersListBottomSheet;
...
import org.papercraft.ui.Components.PacmanAnimation;
...
import org.papercraft.ui.Components.ProxyDrawable;
import org.papercraft.ui.Components.PullForegroundDrawable;
...
import org.papercraft.ui.Components.RecyclerAnimationScrollHelper;
import org.papercraft.ui.Components.RecyclerItemsEnterAnimator;
import org.papercraft.ui.Components.RecyclerListView;
import org.papercraft.ui.Components.SearchViewPager;
...
public class DialogsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, FloatingDebugProvider {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (child instanceof DatabaseMigrationHint) {
                    ...
                    if (filterTabsView != null && filterTabsView.getVisibility() == VISIBLE) {
                        h = heightSize - inputFieldHeight + AndroidUtilities.dp(2) - AndroidUtilities.dp(48) - topPadding - (dialogsHintCell != null ? dialogsHintCell.height() : 0);
                        if (rightSlidingDialogContainer.hasFragment()) {
                            h += AndroidUtilities.dp(48);
                        }
                    } else {
                        h = heightSize - inputFieldHeight + AndroidUtilities.dp(2) - (onlySelect && initialDialogsType != 3 ? 0 : actionBar.getMeasuredHeight()) - topPadding - (dialogsHintCell != null ? dialogsHintCell.height() : 0);
                    }
        ...
        public boolean onTouchEvent(MotionEvent ev) {
            if (parentLayout != null && filterTabsView != null && !filterTabsView.isEditing() && !searching && !rightSlidingDialogContainer.hasFragment() &&
                    ...
                    (ev == null || startedTracking || ev.getY() > actionBar.getMeasuredHeight() + actionBar.getTranslationY()) && (SharedConfig.getChatSwipeAction(currentAccount) == SwipeGestureSettingsView.SWIPE_GESTURE_FOLDERS ||
                            SharedConfig.getChatSwipeAction(currentAccount) == SwipeGestureSettingsView.SWIPE_GESTURE_ARCHIVE && viewPages[0] != null && (viewPages[0].dialogsAdapter.getDialogsType() == 7 || viewPages[0].dialogsAdapter.getDialogsType() == 8)) || filterTabsView != null && initialDialogsType == 3) {
                if (ev != null) {
    ...
    public View createView(final Context context) {
        ...
        if (initialDialogsType == 3 || initialDialogsType == DIALOGS_TYPE_DEFAULT && folderId == 0 && !onlySelect && TextUtils.isEmpty(searchString)) {
...
//                }
        ...
        int pagesCount = initialDialogsType == 3 || (folderId == 0 && initialDialogsType == DIALOGS_TYPE_DEFAULT && !onlySelect) ? 2 : 1;
