...
JNIEXPORT void Java_org_telegram_messenger_Intro_setPapercraftTextures(JNIEnv *env, jclass class, GLuint a_telegram_sphere, GLuint a_telegram_plane, GLuint a_telegram_mask) {
